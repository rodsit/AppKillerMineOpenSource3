...
public class DetailProcess implements Comparable {
    ...
    // public void fetchTaskInfo(TaskManager taskManager) {
    // if (taskinfo == null && appinfo!= null) taskinfo =
    // taskManager.getTaskInfo(appinfo.packageName);
    // }
